...
function wheaterApi({ weather }) {
  ...
  return (
    <div>
      ...
      <div className="wheaterApi">
        <h3>5-Day Forecast:</h3>
        <div className="wheaterApi-container">
          {wheaterApiData &&
            wheaterApiData.slice(0, 5).map((day) => (
